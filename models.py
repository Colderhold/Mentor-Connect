...
class Mentee(db.Model):
  ...
  father_mobile_no = db.Column(db.String(255), nullable=False)
  ...
  mother_mobile_no = db.Column(db.String(255), nullable=False)
...
class Previous_Mentee(db.Model):
   __tablename__ = "previous_mentees"
   mentee = db.Column(db.String(255), primary_key = True)
   fname = db.Column(db.String(255), nullable=False)
   lname = db.Column(db.String(255), nullable=False)
   mentor = db.Column(db.String(255), nullable=False)
